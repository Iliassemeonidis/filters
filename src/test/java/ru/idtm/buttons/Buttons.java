...
public class Buttons {
    ...
    private final static String ADDRESSEES = "Адресаты";
    private final static String ACCEPT = "Принять";
    private final static String IN_RESOLUTION = "На резолюцию";
    private final static String IN_EXECUTE = "На исполнение";
    private final static String REDIRECT = "Переадресовать";
    private final static String SEARCH_ICON = "button.el-tooltip:nth-child(1)";
  private final static String FALSE_ADDRESSEE = "Ошибочный адресат";

    public static void requisites(){ $(byText(REQUISITES)).click(); }
    public static void save(){ $(byText(SAVE)).click(); }
    public static void in_execute(){ $(byText(IN_EXECUTE)).click(); }
    public static void redirect(){ $(byText(REDIRECT)).click(); }
    public static void in_resolution(){ $(byText(IN_RESOLUTION)).click(); }
    ...
    public static void search(){ $(byText(SEARCH)).click(); sleep(1000);}
    public static void addressees(){ $(byText(ADDRESSEES)).click(); sleep(1000);}
    public static void searchIcon(){ $(SEARCH_ICON).click(); sleep(1000);}
    public static void falseAddressee(){ $(byText(FALSE_ADDRESSEE)).click(); sleep(1000);}
